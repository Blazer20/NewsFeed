...
public class FragmentApple extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static FragmentApple newInstance() {
        FragmentApple fragment = new FragmentApple();
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_apple_news, container, false);
    ...
    public void LoadJson(final boolean refresh) {
        ...
        ApiClient.getInstance()
                .getApiInterface()
                .getAppleNews("apple", "popularity", API_KEY)
